...
export class FormatIntelligenceRegistry {
  ...
  public normalizeFormat(format: string): string {
    ...
    const aliases: Record<string, string> = {
      ...
      gen9zu: 'national_dex',
      gen9lc: 'national_dex',
      gen9monotype: 'national_dex',
      gen9cap: 'national_dex',
      gen9anythinggoes: 'national_dex',
      gen91v1: 'national_dex',
      gen9doublesou: 'national_dex',
      gen9doublesubers: 'national_dex',
      gen9doublesuu: 'national_dex',
      gen9doubleslc: 'national_dex',
      gen9vgc2025regi: 'national_dex',
      gen9bssregi: 'national_dex',
      gen9draft: 'national_dex',
      gen96v6doublesdraft: 'national_dex',
      gen94v4doublesdraft: 'national_dex',
      gen9natdexdraft: 'national_dex',
      gen9natdex6v6doublesdraft: 'national_dex',
      gen9natdexlcdraft: 'national_dex',
